...
public class RuntimeManager {
    ...
    public static void standardRuntime(CommandLine commandLine) {
    ...
    public static void libraryExport() { // Transfer database entries to JSON file
    ...
    public static void libraryImport(CommandLine commandLine) { // Take in JSON file and fill database with entries
        Config config = ConfigManager.getConfigurationForRuntime();
    ...
    public static void cleaningProcess(CommandLine commandLine) {
        Config config = ConfigManager.getConfigurationForRuntime();
    ...
    public static void playSong(CommandLine commandLine) {
        Config config = ConfigManager.getConfigurationForRuntime();
