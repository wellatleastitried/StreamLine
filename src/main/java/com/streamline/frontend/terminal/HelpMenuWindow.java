 ...
 */
public class HelpMenuWindow extends BaseWindow {
    
    public HelpMenuWindow(TerminalWindowManager windowManager, Dispatcher backend, TextGUIThread guiThread, TerminalComponentFactory componentFactory) {
