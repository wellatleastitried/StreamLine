...
public class RecentlyPlayedPage extends AbstractDynamicPage {
    ...
    public RecentlyPlayedPage(Dispatcher backend, TextGUIThread guiThread) {
        ...
        setWindowTitle(getText("window.downloadedMusicTitle"));
    ...
    private void buildPage() {
        ...
        songButtons.clear();
        addSpace();
        mainPanel.addComponent(createLabel(getText("label.downloadedMusicTitle")));
        addSpace();
    ...
    public String getPageName() {
        return StreamLineConstants.RECENTLY_PLAYED_PAGE;
    }
}
