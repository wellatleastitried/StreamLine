...
public class DownloadedMusicPage extends BasePage {
    ...
    public BasicWindow createWindow() {
        downloadedButtons = new HashMap<Integer, Button>();
    ...
    private void resultsToButtons(Panel resultsPanel, RetrievedStorage results) {
        downloadedButtons = new HashMap<>();
        for (int i = 0; i < results.size(); i++) {
            ...
            String formattedText = componentFactory.getFormattedTextForSongButton(
                    ...
                    song.getSongArtist(),
                    song.getDuration());
            downloadedButtons.put(i, componentFactory.createButton(
                        formattedText, 
    ...
    private void updateResultsDisplay(Panel resultsBox, Set<Button> currentButtons) {
        guiThread.invokeLater(() -> {
            ...
            for (Map.Entry<Integer, Button> entry : downloadedButtons.entrySet()) {
